 ...
 *  above the Pixi canvas that should intercept sprite hover/click (e.g. track legends and
 *  tooltips, see `data-gentrack-overlay-blocker` in GenTrack.tsx and GenTrackTooltip.tsx). */
 ...
 * the canvas (e.g. a track legend or tooltip) does NOT prevent PixiJS from firing
