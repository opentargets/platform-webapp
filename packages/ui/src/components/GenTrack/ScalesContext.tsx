...
export interface ScalesRef {
  ...
  // Pixi-rendered components (e.g. GeneInteractionBox, via useStickyTick) inside their useTick
  ...
  stickyLabelCenter: number | null; // identity for genes, matches GeneInteractionBox's labelCenter
